...
$products_list = array(
    1 => array( 
            'product_id' => '151',    //код товара (из каталога CRM)
...
// параметры запроса
$data = array(
    'key'             => '7e74de1b97e3d486acea4b6511642be6', //Ваш секретный токен
...
// запрос
$curl = curl_init();
curl_setopt($curl, CURLOPT_URL, 'http://artiphone.lp-crm.biz/api/addNewOrder.html');
